...
# Fungsi untuk menyimpan kode valid ke file
...
sem = asyncio.Semaphore(200)  # Optimalkan semafor untuk membatasi lebih banyak koneksi
            ...
            try:
                async with session.post(
                    ...
                    if response.status == 200:
                        await save_valid_code(code)  # Simpan kode valid secara otomatis
